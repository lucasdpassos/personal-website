  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-primary text-white p-4 space-y-8">
      <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-6 relative">
        ...
        {/* Balão de diálogo */}
        <div 
          className="hidden md:block absolute -top-10 md:-top-16 right-0 md:right-[-220px] w-64 h-24 p-4 bg-effect bg-opacity-30 rounded-lg shadow-lg text-white flex flex-col justify-center items-center"
        >
          <div className="flex space-x-4"> {/* Container para os ícones */}
          {/* Ícone TypeScript */}
          <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 text-white" fill="currentColor">
